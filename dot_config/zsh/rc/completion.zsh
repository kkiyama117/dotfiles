...
zstyle ':completion:*' completer _expand _complete _correct _approximate _ignored _oldlist
...
zstyle ':completion:*' auto-description 'specify: %d' # MINE
zstyle ':completion:*' group-name ''
zstyle ':completion:*' keep-prefix
zstyle ':completion:*' recent-dirs-insert both
# Color-code the completion candidates (Adapted from GNU ls color definitions)
zstyle ':completion:*' list-colors "${LS_COLORS}"
zstyle ':completion:*:default' list-colors ${(s.:.)LS_COLORS} # MINE
...
zstyle ':completion:*' use-compctl false # MINE
zstyle ':completion:*' verbose true # MINE
...
zstyle ':completion:*' menu select=2 #MINE
...
zstyle ':completion:*' list-prompt %SAt %p: Hit TAB for more, or the character to insert%s # MINE
